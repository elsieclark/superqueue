...
module.exports = {
    ...
    findUnlockTime: (flag, flagName) => {
        ...
        // If not enough items have been sent to fill the queue even once, rate isn't an issue
    ...
    updateForExecutionStart: (flag) => {
        ...
        flag.concurrent++;
        flag.length--;
        if (flag.recent.length < flag.rate || flag.recent.length === 0) {
