...
const SuperQueue = function (options) {
    ...
    this.push = (...args) => {
        return new Promise((resolve, reject) => {
            ...
            if (typeof args[0] === 'function') {
                ...
                queueItem.flags.concat(Valid.flagArr([...new Set(funcOptions.flags)], flags));
            } else {
            ...
            const newIndex = queue.findIndex((o) => { return o.priority < queueItem.priority });
    ...
    this.addFlag = (flagOptions) => {
        if (!Valid.isStringOrSymbol(flagOptions.name) || !flagOptions.name) {
